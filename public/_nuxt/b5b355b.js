      ...
      function c(t, filter, e) {
        ...
        switch (c) {
          case 'select':
            ...
            return v.length ? (f[r] = v) : delete f[r], f;
          case 'range':
      ...
      var h = {
        ...
        component = Object(y.a)(
          ...
          function () {
            ...
            return e(
              'transition',
              { attrs: { name: 'slide-modal-ltr', duration: 700 } },
              [
                e('div', { staticClass: 'fixed inset-0 z-50' }, [
                  ...
                  e(
                    ...
                    {
                      staticClass:
                        'panel absolute left-0 h-full w-full overflow-scroll bg-primary-lightest md:max-w-112',
                    },
                    [
                      e(
                        'div',
                        {
                          staticClass:
                            'flex items-center border-b border-primary-light p-6',
                        },
                        [
                          e('h3', [t._v(t._s(t.$t('categories.slug.refine')))]),
                          t._v(' '),
                          e(
                            'button',
                            {
                      ...
                      e(
                        'div',
                        {
                          ...
                          staticClass:
                            'overflow-hidden border-b border-primary-light bg-primary-lighter py-4 px-6 text-sm',
                        },
                        [
                          e(
                            'div',
                        ...
                        [
                          ...
                          e('BaseButton', {
                            attrs: {
                              appearance: 'dark',
                              size: 'lg',
                              label: t.$t('categories.slug.apply'),
                            },
                            nativeOn: {
                              click: function (e) {
                                return t.applyFilters.apply(null, arguments);
                              },
                            },
                          }),
                        ],
