                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          (r = c.a.instance()),
                          (e.next = 3),
                          r.get('getOrder/' + t.$route.params.id)
                        );
                      case 3:
                        200 === (data = e.sent).status &&
                          (t.order = data.data.data);
                      case 5:
                      case 'end':
                        return e.stop();
                    }
                ...
                ? e('div', [
                    e('div', { staticClass: 'container' }, [
                      e(
                        ...
                        {
                          staticClass:
                            'mb-10 mt-8 border-b border-primary-med pb-6',
                        },
                        [
