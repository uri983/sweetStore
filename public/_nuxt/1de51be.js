          ...
          e.default = {
            ...
            computed: {
              staticPosition: function () {
                var t =
                    ((this.staticValue - this.minimum) / this.spacing) *
                    this.gap,
                  e = s(
              ...
              currentIndex: function () {
                return this.isRange
                  ...
                  : this.data
                  ? this.currentValue
                  : this.getIndexByValue(this.currentValue);
              },
              indexRange: function () {
                return this.isRange
                  ? this.currentIndex
              ...
              focusStyles: function () {
                return Array.isArray(this.focusStyle)
                  ? this.isRange
                    ? this.focusStyle
                    : this.focusStyle[1]
              ...
              piecewiseDotWrap: function () {
                ...
                for (var t = [], e = 0; e <= this.total; e++) {
                  ...
                  (this.piecewiseFilter &&
                    !this.piecewiseFilter({ index: s, label: r })) ||
                    t.push({
                      style: i,
                      index: s,
            ...
            methods: {
              ...
              changeFocusSlider: function (t) {
                ...
                if (this.isRange) {
                  ...
                  i[0] > i[1] &&
                    ((this.focusSlider = 0 === this.focusSlider ? 1 : 0),
                    (i = i.reverse())),
                    this.setIndex(i);
              ...
              blurSlider: function (t) {
                var e = this.isRange
                  ...
                  : this.$refs.dot;
                if (!e || e === t.target || e.contains(t.target)) return !1;
                this.focusFlag = !1;
              },
              ...
              wrapClick: function (t) {
                ...
                if (
                  (this.setValueOnPos(i), this.isRange && this.tooltipMerge)
                ) {
              ...
              moveStart: function (t) {
                ...
                if (
                  (this.stopPropagation && t.stopPropagation(), this.isRange)
                ) {
                ...
                !i &&
                  this.useKeyboard &&
                  ((this.focusFlag = !0), (this.focusSlider = e)),
                  (this.flag = !0),
              ...
              moving: function (t) {
                ...
                t.preventDefault(),
                  ...
                  this.processFlag
                    ? ((this.currentSlider = 0),
                      this.setValueOnPos(
                        this.processSign.pos[0] +
                          this.getPos(t) -
                          this.processSign.start,
                        !0,
                      ),
                      (this.currentSlider = 1),
                      this.setValueOnPos(
                        this.processSign.pos[1] +
                          this.getPos(t) -
                          this.processSign.start,
                        !0,
                      ))
              ...
              setValueOnPos: function (t, e) {
                ...
                if (t >= i[0] && t <= i[1]) {
                  ...
                  var n = t < i[0] ? 0 : 1,
                    l = 0 === n ? 1 : 0;
                  this.setTransform(i[n]),
                    this.setCurrentValue(s[n]),
                    this.isRange && (this.fixed || this.isLessRange(t, r))
                      ? (this.setTransform(this.limit[this.idleSlider][n], !0),
                        this.setCurrentValue(
                          this.valueLimit[this.idleSlider][n],
                          e,
                          !0,
                        ))
                      : !this.isRange ||
                        ...
                        this.isFixed ||
                        this.disabledArray[n] ||
                        this.currentSlider !== l ||
                        ((this.focusSlider = n), (this.currentSlider = n));
                }
                this.crossFlag = !1;
              },
              isLessRange: function (t, e) {
                ...
                var i =
                  0 === this.currentSlider
                    ? this.currentIndex[1] - e
                    : e - this.currentIndex[0];
                return this.minRange && i <= this.minRange
                  ? ((this.fixedValue = this.minRange), !0)
                  : this.maxRange && i >= this.maxRange
                  ? ((this.fixedValue = this.maxRange), !0)
                  : (this.computedFixedValue(), !1);
              },
              isDiff: function (t, e) {
                return (
              ...
              setCurrentValue: function (t, e, i) {
                ...
                this.isRange
                  ? this.isDiff(this.currentValue[s], t) &&
                    (this.currentValue.splice(s, 1, t),
                    (this.lazy && this.flag && !this.keydownFlag) ||
                      this.syncValue())
              ...
              getIndexByValue: function (t) {
                return this.data
                  ? this.data.indexOf(t)
                  : Math.round((t - this.minimum) * this.multiple) /
              ...
              setIndex: function (t) {
                if (Array.isArray(t) && this.isRange) {
                  ...
                  (e = this.data
                    ...
                    : [this.getValueByIndex(t[0]), this.getValueByIndex(t[1])]),
                    this.setValue(e);
                } else
                  (t = this.getValueByIndex(t)),
                    this.isRange &&
                      (this.currentSlider =
                        t >
              ...
              setValue: function (t, e, i) {
                ...
                if (this.isDiff(this.val, t)) {
                  ...
                  (this.val = this.isRange ? r.concat() : r),
                    this.computedFixedValue(),
                    this.syncValue(e);
                }
                this.$nextTick(function () {
              ...
              setTransform: function (t, e) {
                var i = e ? this.idleSlider : this.currentSlider,
                  ...
                  n = this.fixed
                    ...
                    : (0 === i ? this.position[1] - t : t - this.position[0]) +
                      'px',
                  l = this.fixed
                    ? (0 === i ? t : t - this.fixedValue * this.gap) + 'px'
                    : (0 === i ? t : this.position[0]) + 'px';
                this.isRange
                  ? ((this.slider[i].style.transform = o),
                    (this.slider[i].style.WebkitTransform = o),
                    (this.slider[i].style.msTransform = o),
                    'vertical' === this.direction
                      ? ((this.$refs.process.style.height = n),
                        (this.$refs.process.style[
                          this.reverse ? 'top' : 'bottom'
                        ] = l))
                      : ((this.$refs.process.style.width = n),
                        (this.$refs.process.style[
                          this.reverse ? 'right' : 'left'
                        ] = l)))
                  : ((this.slider.style.transform = o),
                    (this.slider.style.WebkitTransform = o),
                    (this.slider.style.msTransform = o),
                    'vertical' === this.direction
                ...
                if ((t || this.$refs.process.offsetWidth, this.isRange)) {
                  for (var e = 0; e < this.slider.length; e++)
                    (this.slider[e].style.transitionDuration = t + 's'),
                      (this.slider[e].style.WebkitTransitionDuration = t + 's');
              ...
              syncValue: function (t) {
                ...
                this.$emit('input', e),
                  this.keydownFlag && this.$emit('on-keypress', e),
                  t || this.$emit('callback', e);
              },
              getValue: function () {
                return this.val;
              },
              ...
              handleOverlapTooltip: function () {
                ...
                if (this.isRange && t) {
                  var e = this.reverse
                    ...
                    u = 'vertical' === this.direction && a > l;
                  d || u
                    ? this.handleDisplayMergedTooltip(!0)
                    : this.handleDisplayMergedTooltip(!1);
                }
              },
              handleDisplayMergedTooltip: function (t) {
                var e = this.$refs.tooltip0,
                  ...
                  s =
                    this.$refs.process.getElementsByClassName(
                      'vue-merged-tooltip',
                    )[0];
                t
            ...
            mounted: function () {
              ...
              this.$nextTick(function () {
                t.isComponentExists &&
                  (t.getStaticData(),
                  t.setValue(
                    t.limitValue(t.value),
                    !0,
                    t.startAnimation ? t.speed : 0,
                  ),
                  t.bindEvents(),
                  t.isRange &&
                    t.tooltipMerge &&
            ...
            render: function () {
              ...
              return i(
                'div',
                {
                  ...
                  style: [
                    t.wrapStyles,
                    t.boolDisabled ? t.disabledStyle : null,
                  ],
                                ...
                                class: [
                                  ...
                                  'vue-slider-dot',
                                  {
                                    'vue-slider-dot-focus':
                                      t.focusFlag && 0 === t.focusSlider,
                                    'vue-slider-dot-dragging':
                                      t.flag && 0 === t.currentSlider,
                                    'vue-slider-dot-disabled':
                                      !t.boolDisabled && t.disabledArray[0],
                                  },
                                ],
                                style: t.dotStyles,
                                on: {
                            ...
                            i(
                              'div',
                              {
                                ...
                                class: [
                                  ...
                                  {
                                    'vue-slider-dot-focus':
                                      t.focusFlag && 1 === t.focusSlider,
                                    'vue-slider-dot-dragging':
                                      t.flag && 1 === t.currentSlider,
                                    'vue-slider-dot-disabled':
                                      !t.boolDisabled && t.disabledArray[1],
                                  },
                                ],
                                style: t.dotStyles,
                                on: {
                              ...
                              ? i(
                                  'div',
                                  {
                                    ...
                                    class: [
                                      ...
                                      {
                                        'vue-slider-dot-active': t.isActive(
                                          t.getIndexByValue(t.staticValue),
                                        ),
                                      },
                                    ],
                                    style: [t.staticPosition, t.dotStyles],
                                    on: {
                                      click: function (e) {
                                        return (
                                          e.stopPropagation(),
                                          t.clickable &&
                                            t.setValue(t.staticValue)
                                        );
                                      },
                                    },
                                  },
                            ...
                            i(
                              ...
                              [
                                t._t(
                                  ...
                                  { value: t.val, disabled: t.boolDisabled },
                                ),
                                t._v(' '),
                                i(
                                  'div',
                            ...
                            [
                              t._t(
                                  ...
                                  t.piecewise
                                    ? i('span', {
                                        class: [
                                          ...
                                          {
                                            'vue-slider-piecewise-dot-active':
                                              t.isActive(e.index),
                                          },
                                        ],
                                        style: [
                                ...
                                ],
                                {
                                  ...
                                  active: t.isActive(e.index),
                                  total: t.piecewiseDotWrap.length,
                                },
                              ),
                              t._v(' '),
                              t._t(
                        ...
                        [
                          i(
                            'div',
                            {
                              ...
                              class: [
                                'vue-merged-tooltip',
                                'vue-slider-tooltip-' + t.tooltipDirection[0],
                                'vue-slider-tooltip-wrap',
                              ],
          ...
          function s(t) {
            for (var e = 0; e < t.length; e++) {
              ...
              if (s) {
                ...
                var n = [];
                for (r = 0; r < i.parts.length; r++) n.push(o(i.parts[r]));
