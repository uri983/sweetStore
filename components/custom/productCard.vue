<template>
  <article class="mb-3 rounded px-1 shadow-lg sm:px-2 xl:mb-4 xl:px-3">
    <!-- Skeleton loader -->
      ...
      <div class="py-3" :style="{ 'text-align': textAlign }">
        ...
        <template v-if="showPrice">
          ...
          <div class="my-8">
            <ul class>
              <li
                v-for="(benefit, index) in product.content.productBenefits"
          ...
          <btnAddToCar
            v-if="quickAddIsEnabled && product.price !== null"
            :product="product"
            @adding-to-cart="productBeingAdded = product.id"
            @keep-alive="keepQuickAddAlive"
          />
...
import btnAddToCar from './btnAddToCar.vue';
