<template>
  <div ref="header" data-sw-path="header" class="bg-white">
    ...
    <div class="opacity-0">
      ...
      />
      <div class="py-3">
        <span v-if="logoSrc" :style="{ height: 40 + 'px' }" class="block" />
    ...
    <div class="fixed top-0 z-40 w-full">
      ...
      >
        <header
          class="z-40 bg-white transition-all duration-300 ease-in-out"
          :class="{
        ...
        >
          ...
          >
            ...
            <!-- Main nav menu -->
            <nav v-if="customMenu" class="hidden w-full lg:flex lg:w-auto">
            ...
            <div class="-mr-2 flex flex-row items-center justify-end lg:w-1/4">
              ...
              >
                <BaseIcon class="text-sweetPrimary" icon="uil:search" />
              </button>
              <!-- Account icon -->
              <NuxtLink
                ...
                "
              >
                <BaseIcon class="text-sweetPrimary" icon="uil:user" />
              </NuxtLink>
              <!-- Cart icon -->
              <button
                ...
                "
              >
                <BaseIcon class="text-sweetPrimary" icon="uil:cart" />
                <div
                  v-if="cart && cart.itemQuantity"
                  class="fade-in absolute top-0 left-5 flex h-6 w-6 items-center justify-center rounded-full bg-sweetPrimary text-primary-lighter"
                >
              ...
              >
                <span class="center-xy absolute h-6 w-6">
                  <span class="hamburger-inner text-sweetPrimary"></span>
                </span>
              </button>
            </div>
          </div>
