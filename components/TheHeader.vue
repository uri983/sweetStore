<template>
  <div ref="header" data-sw-path="header" class="bg-sweetPrimary">
    ...
    <div class="fixed top-0 z-40 w-full">
      ...
      >
        <header
          class="z-40 bg-sweetPrimary transition-all duration-300 ease-in-out"
          :class="{
...
export default {
  ...
  async fetch() {
    ...
    this.storeName = 'Sweet Spot Dev'; // await $swell.settings.get('store.name');
